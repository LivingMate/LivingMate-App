...
const ExpenseView:React.FC<ExpenseViewProps> = ({budgets, fetchBudgets}) => {
  ...
  return (
    <View style={CommonStyles.baseContainer}>
      ...
      <RegisterBudgetModalContainer mode={modalMode} isVisible={modalVisible} onClose={closeModal} fetchBudgets={fetchBudgets} />
    </View>
  );
}
